...
/// Bindings for `src/swap_controller_flutter.h`.
///
/// Regenerate bindings with `dart run ffigen --config ffigen.yaml`.
///
class SwapControllerNativeLibrary {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  SwapControllerNativeLibrary(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  SwapControllerNativeLibrary.fromLookup(
  ...
  void InitializedAzkadevGamePadNativeGeneralUniverseCallbackFunction(
    ffi.Pointer<ffi.Void> callback,
  ) {
    return _InitializedAzkadevGamePadNativeGeneralUniverseCallbackFunction(
      callback,
    );
  }

  late final _InitializedAzkadevGamePadNativeGeneralUniverseCallbackFunctionPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>(
          'InitializedAzkadevGamePadNativeGeneralUniverseCallbackFunction');
  late final _InitializedAzkadevGamePadNativeGeneralUniverseCallbackFunction =
      _InitializedAzkadevGamePadNativeGeneralUniverseCallbackFunctionPtr
          .asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Char> InvokeAzkadevGamePadNativeFunction(
    ffi.Pointer<ffi.Char> parameters,
  ) {
    return _InvokeAzkadevGamePadNativeFunction(
      parameters,
    );
  }

  late final _InvokeAzkadevGamePadNativeFunctionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(
              ffi.Pointer<ffi.Char>)>>('InvokeAzkadevGamePadNativeFunction');
  late final _InvokeAzkadevGamePadNativeFunction =
      _InvokeAzkadevGamePadNativeFunctionPtr.asFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
}
